...
import { createPost, deletePost, getAllPosts, getPostByUserId, getSubjects } from '../controllers/posts.controller.js';
...
postRouter.get("/getSkills", generalLimiter, getSubjects);
